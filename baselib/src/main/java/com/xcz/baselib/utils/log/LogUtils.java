package com.xcz.baselib.utils.log;
...
import com.xcz.baselib.BuildConfig;
...
public final class LogUtils {
    ...
    private static boolean sLogSwitch = BuildConfig.DEBUG;  // log 总开关，默认开
    private static boolean sLog2ConsoleSwitch = BuildConfig.DEBUG;  // logcat 是否打印，默认打印
